...
cp $FILEDEST/ustadmobile_apptests.html $FILEDEST/index.html
...
sed -i.backup2 -e 's/ACCESS_FINE_LOCATION\"/ACCESS_FINE_LOCATION\" android:required=\"false\"/' $WORKINGDIR/build-test/ustadmobile/platforms/android/AndroidManifest.xml
sed -i.backup3 -e 's/ACCESS_FINE_LOCATION\"/ACCESS_COARSE_LOCATION\" android:required=\"false\"/' $WORKINGDIR/build-test/ustadmobile/platforms/android/AndroidManifest.xml
