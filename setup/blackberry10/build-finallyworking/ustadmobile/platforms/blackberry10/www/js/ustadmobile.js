...
//alert("BB10TEST: Ustad Mobile: Current Location: " + currentUrl); //For testing purposes.
...
if (typeof userAgentPlatform === 'undefined'){	//Possibility of Blackberry
    ...
    if(userAgentPlatform.indexOf("BB10") !== -1) {
...
function onAppDeviceReady(){
    //alert("BB10TEST: Cordova ready at ustadmobile.js");
...
function openPage2(openFile){
    //alert("BB10TEST: Ustad Mobile: Current Location: " + document.URL); //For testing purposes.
    ...
    window.open(openFile, '_self'); //BB changes so that it loads in current child webview
